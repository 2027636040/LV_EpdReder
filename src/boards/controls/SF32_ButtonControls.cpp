...
{
#if defined (BSP_USING_BOARD_SF32_OED_EPD_V11) || defined(BSP_USING_BOARD_SF32_OED_EPD_V12_SPI) || defined(BSP_USING_BOARD_SF32_OED_EPD_V12) || defined(BSP_USING_BOARD_DPI_HDK_LB575YBBN6_N16_EPD) || defined(BSP_USING_BOARD_DPI_HDK_LB57GYD7N6_EPD)
  {
...
#if !defined(BSP_USING_BOARD_SF32_OED_EPD_V12_SPI) && !defined(BSP_USING_BOARD_SF32_OED_EPD_V11) && !defined(BSP_USING_BOARD_SF32_OED_EPD_V12) && !defined(BSP_USING_BOARD_DPI_HDK_LB575YBBN6_N16_EPD) && !defined(BSP_USING_BOARD_DPI_HDK_LB57GYD7N6_EPD)
  cfg.pin = EPD_KEY2;
  cfg.active_state = BUTTON_ACTIVE_HIGH;
  cfg.mode = PIN_MODE_INPUT;
  cfg.button_handler = button_event_handler;
